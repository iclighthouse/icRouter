// pncff-zqaaa-aaaai-qnp3a-cai
// https://github.com/eleven-cat/ICOracle/
// Getting price data from ICOracle (there is a possibility that the dapp is not maintained)
